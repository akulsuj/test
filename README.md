...
# Patch 'dbops_obj' in the 'Services.fileoperations' module BEFORE import
@patch('Services.fileoperations.dbops_obj')
...
class Test_FileOperations(unittest.TestCase):
    ...
    def setUp(self, mock_dbops_obj):
        """Set up for the test, with the database object mocked."""
        self.mock_dbops_obj = mock_dbops_obj

        # Configure the mock object's behavior. Any call to methods of
        # mock_dbops_obj will now interact with this mock, not the real database.
