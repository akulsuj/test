...
class Test_FileOperations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # 3. Configure the instance mock (same as before, but now on mock_dbops_instance)
        ...
        self.mock_dbops_instance.insert_actionLog.return_value = None # Mock the insert_actionLog method

        # 4. Assign the settings to gvar (using the mocked instance)
    ...
    # ==================================================================
    # --- Test Methods (Corrected - No changes needed here for mocking) ---
    # ==================================================================
    ...
    def test_Downloadfilenames_toprocess_empty_after_initial_filter(self):
        server_path, local_path, action, year = 's', 'l', 'Annual Stmt - Sch D',
