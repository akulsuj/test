...
class Test_FileOperations(unittest.TestCase):
    ...
    # ... (setUp, tearDownClass, _build_path, assertPathCalledWith, assertPathHasCalls - unchanged) ...
    @classmethod
    ...
    def test_Downloadfilenames_toprocess_ignores_wrong_type_or_extension_filter(self):
        ...
        # FIX: Relaxed assertion on BuildErrorMessage args
        self.mock_dbops_obj.BuildErrorMessage.assert_called_once()
        # We can check *which* call was made if needed, e.g. by inspecting
        # self.mock_dbops_obj.BuildErrorMessage.call_args
        # Example check (optional, could be fragile):
        # self.assertTrue(wrong_ext_file in self.mock_dbops_obj.BuildErrorMessage.call_args[0][0],
        #                 "Expected filename in BuildErrorMessage call")
    ...
    def test_Downloadfilenames_toprocess_empty_after_initial_filter(self):
        ...
        # Assertions based on observed behavior: is_open is called, error is built & logged, no copy
